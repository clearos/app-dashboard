...
echo field_button_set(
    array(
        anchor_custom('/app/dashboard/shutdown/confirm_shutdown', lang('base_shutdown'), 'high'),
        anchor_custom('/app/dashboard/shutdown/confirm_restart', lang('base_restart'), 'high')
    )
);
